-- <Migration ID="f15ff9d3-41cd-4a36-af43-be6abf7d2533" TransactionHandling="Custom" />
GO
...
GO
IF NOT EXISTS (SELECT 1 FROM sys.objects WHERE object_id = OBJECT_ID(N'[Production].[UQ__Document__F73921F744672977]', 'UQ') AND parent_object_id = OBJECT_ID(N'[Production].[Document]', 'U'))
ALTER TABLE [Production].[Document] ADD CONSTRAINT [UQ__Document__F73921F744672977] UNIQUE NONCLUSTERED ([rowguid])
GO
PRINT N'Adding full text indexing to tables'
GO
...
'
GO
PRINT N'Creating [Person].[Pet]'
GO
IF OBJECT_ID(N'[Person].[Pet]', 'U') IS NULL
...
GO
PRINT N'Creating primary key [PK_Pet] on [Person].[Pet]'
GO
IF NOT EXISTS (SELECT 1 FROM sys.objects WHERE object_id = OBJECT_ID(N'[Person].[PK_Pet]', 'PK') AND parent_object_id = OBJECT_ID(N'[Person].[Pet]', 'U'))
...
GO
IF NOT EXISTS (SELECT 1 FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[Person].[FK_Person_PetID]','F') AND parent_object_id = OBJECT_ID(N'[Person].[Person]', 'U'))
...
GO
PRINT N'Adding foreign keys to [Person].[Pet]'
GO
IF NOT EXISTS (SELECT 1 FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[Person].[FK_Pet_OwnerID]','F') AND parent_object_id = OBJECT_ID(N'[Person].[Pet]', 'U'))
