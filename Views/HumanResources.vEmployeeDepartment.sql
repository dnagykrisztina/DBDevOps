...
AS
SELECT        e.BusinessEntityID, p.Title, p.FirstName, p.MiddleName, p.LastName, e.JobTitle, d.Name AS Department, d.GroupName, edh.StartDate
...
Begin DesignProperties = 
   ...
   End
End
', 'SCHEMA', N'HumanResources', 'VIEW', N'vEmployeeDepartment'
GO

EXEC sys.sp_addextendedproperty N'MS_DiagramPaneCount', 1, 'SCHEMA', N'HumanResources', 'VIEW', N'vEmployeeDepartment'
GO