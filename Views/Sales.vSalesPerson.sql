...
AS
SELECT        s.BusinessEntityID, p.Title, p.FirstName, p.MiddleName, p.LastName, e.JobTitle, pp.PhoneNumber, pnt.Name AS PhoneNumberType, ea.EmailAddress, p.EmailPromotion, a.AddressLine1, a.AddressLine2, a.City, 
                         sp.Name AS StateProvinceName, a.PostalCode, cr.Name AS CountryRegionName, st.Name AS TerritoryName, st.[Group] AS TerritoryGroup, s.SalesQuota, s.SalesYTD, s.SalesLastYear
   ...
   Begin DiagramPane = 
      ...
      Begin Tables = 
         ...
         Begin Table = "cr"
            ...
            DisplayFlags = 280
            TopColumn = 0
         En', 'SCHEMA', N'Sales', 'VIEW', N'vSalesPerson'
GO
...
EXEC sys.sp_addextendedproperty N'MS_DiagramPane2', N'd
   ...
   End
End
', 'SCHEMA', N'Sales', 'VIEW', N'vSalesPerson'
GO

EXEC sys.sp_addextendedproperty N'MS_DiagramPaneCount', 2, 'SCHEMA', N'Sales', 'VIEW', N'vSalesPerson'
GO