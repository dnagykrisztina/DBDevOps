...
AS
SELECT        e.BusinessEntityID, p.Title, p.FirstName, p.MiddleName, p.LastName, s.Name AS Shift, d.Name AS Department, d.GroupName, edh.StartDate, edh.EndDate
...
Begin DesignProperties = 
   ...
   End
End
', 'SCHEMA', N'HumanResources', 'VIEW', N'vEmployeeDepartmentHistory'
GO

EXEC sys.sp_addextendedproperty N'MS_DiagramPaneCount', 1, 'SCHEMA', N'HumanResources', 'VIEW', N'vEmployeeDepartmentHistory'
GO