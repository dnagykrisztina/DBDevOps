...
GO
INSERT Production.ProductReview(ProductReviewID, ProductID, ReviewerName, ReviewDate, EmailAddress, Rating, Comments, ModifiedDate) VALUES (1, 709, N'John Smith', '2013-09-18 00:00:00.000', N'john@fourthcoffee.com', 5, N'I can''t believe I''m singing the praises of a pair of socks, but I just came back from a grueling
...
I won''t go on another trip without them!', '2013-09-18 00:00:00.000')
INSERT Production.ProductReview(ProductReviewID, ProductID, ReviewerName, ReviewDate, EmailAddress, Rating, Comments, ModifiedDate) VALUES (2, 937, N'David', '2013-11-13 00:00:00.000', N'david@graphicdesigninstitute.com', 4, N'A little on the heavy side, but overall the entry/exit is easy in all conditions. I''ve used these pedals for 
more than 3 years and I''ve never had a problem. Cleanup is easy. Mud and sand don''t get trapped. I would like 
them even better if there was a weight reduction. Maybe in the next design. Still, I would recommend them to a friend.', '2013-11-13 00:00:00.000')
INSERT Production.ProductReview(ProductReviewID, ProductID, ReviewerName, ReviewDate, EmailAddress, Rating, Comments, ModifiedDate) VALUES (3, 937, N'Jill', '2013-11-15 00:00:00.000', N'jill@margiestravel.com', 2, N'Maybe it''s just because I''m new to mountain biking, but I had a terrible time getting use
to these pedals. In my first outing, I wiped out trying to release my foot. Any suggestions on
ways I can adjust the pedals, or is it just a learning curve thing?', '2013-11-15 00:00:00.000')
INSERT Production.ProductReview(ProductReviewID, ProductID, ReviewerName, ReviewDate, EmailAddress, Rating, Comments, ModifiedDate) VALUES (4, 798, N'Laura Norman', '2013-11-15 00:00:00.000', N'laura@treyresearch.net', 5, N'The Road-550-W from Adventure Works Cycles is everything it''s advertised to be. Finally, a quality bike that
...
any level of experience. It''s a huge step in the right direction for female cyclists and well worth your consideration and hard-earned money.', '2013-11-15 00:00:00.000')
GO
